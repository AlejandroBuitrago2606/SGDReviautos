                    ...
                    <div class="table-row" style="display: flex; align-items: center; justify-content: space-between; padding: 15px 20px; gap: 15px;">
                        ...
                        <form action="/editarProceso" method="POST" style="flex: 1; min-width: 0;">
                            ...
                            <div class="row" style="display: flex; align-items: center; justify-content: space-between;">
                                ...
                                <div class="col-10">
                                    <div class="form-group" id="formEditar{{ $proceso->idProceso }}" style="display: none; width: 80%;">

                                        <input type="hidden" name="idProceso" id="idProceso" value="{{ $proceso->idProceso }}">
                                ...
                                <div class="col-2">
                                    ...
                                    <div class="action-buttons" id="btnAtras{{ $proceso->idProceso }}" data-proceso-id="{{ $proceso->idProceso }}" onclick="mostrarFormProceso(event)" style="margin: 0; display: none;">
                        ...
                        <div style="display: flex; gap: 20px; flex-shrink: 0;">
                            ...
                            <div class="action-buttons" id="btnEdit{{ $proceso->idProceso }}" data-proceso-id="{{ $proceso->idProceso }}" onclick="mostrarFormProceso(event)" style="margin: 0;">
                            ...
                            <form action="/eliminarProceso/{{ $proceso->idProceso }}" method="POST">
            ...
            <div class="modal-body p-4">
                ...
                <div class="documents-table">
                    ...
                    <div class="table-row" style="display: flex; align-items: center; justify-content: space-between; padding: 15px 20px; gap: 15px;">
                        ...
                        <div style="flex: 1; min-width: 0;" id="infoCategory{{ $categoria->idTipoDocumento }}">
                        ...
                        <form action="" method="POST" style="flex: 1; min-width: 0;">
                            ...
                            <div class="row" style="display: flex; align-items: center; justify-content: space-between;">
                                ...
                                <div class="col-10">
                                    <div class="form-group" id="formEditarCategory{{ $categoria->idTipoDocumento }}" style="display: none; flex: 1; min-width: 0;">

                                        <input type="hidden" name="idTipoDocumento" value="{{ $categoria->idTipoDocumento }}">
                                ...
                                <div class="col-2">
                                    <div class="action-buttons" id="btnSaveCategory{{ $categoria->idTipoDocumento }}" style="margin: 0; display: none;">
                                        <button class="action-btn btn-save" title="Guardar" style="margin-bottom: 5px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="#fff" d="M21 7v12q0 .825-.587 1.413T19 21H5q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h12zm-9 11q1.25 0 2.125-.875T15 15t-.875-2.125T12 12t-2.125.875T9 15t.875 2.125T12 18m-6-8h9V6H6z" />
                                            </svg>
                                    ...
                                    <div class="action-buttons" id="btnBackCategory{{ $categoria->idTipoDocumento }}" data-category-id="{{ $categoria->idTipoDocumento }}" onclick="mostrarFormCategory(event)" style="margin: 0; display: none;">
                        ...
                        <div style="display: flex; gap: 20px; flex-shrink: 0;">
                            <div class="action-buttons" id="btnEditCategory{{ $categoria->idTipoDocumento}}" data-category-id="{{ $categoria->idTipoDocumento }}" onclick="mostrarFormCategory(event)" style="margin: 0;">
                                <button class="action-btn btn-edit" title="Editar" style="margin-bottom: 5px;">
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" />
                                    </svg>
